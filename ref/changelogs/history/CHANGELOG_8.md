...
> 完整 review 报告 + 三态裁决证据见 [reviews/REVIEW_3.md](../../reviews/history/REVIEW_3.md)。
...
- review 完整报告：[reviews/REVIEW_3.md](../../reviews/history/REVIEW_3.md)
...
> 完整三态裁决清单 / 验证手段 / ❌ 反驳依据见 [reviews/REVIEW_4.md](../../reviews/history/REVIEW_4.md)。本节按严重度倒序列 fix 落地（R_1 + R_2 共 30 条）。
...
### Agent 踩坑沉淀（原写入后来已移除的 `.claude/conventions-tally.md`）
