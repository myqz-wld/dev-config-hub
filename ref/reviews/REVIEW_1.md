...
用户主动评估「如果今天就要在 Windows 上跑 / 打包 / 分发，会撞到哪些硬伤、哪些半软伤、哪些其实已经覆盖好了」。dev-config-hub 与 agent-deck 同期联合 review（agent-deck 见 [REVIEW_21](../../../agent-deck/reviews/REVIEW_21.md)）。
